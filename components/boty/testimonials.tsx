...
const testimonials = [
  {
    ...
    location: "Kathmandu",
    rating: 5,
    text: "My skin has never felt so soft and nourished. The Face Serum is now a permanent part of my morning routine.",
    product: "Face Serum"
  },
  {
    id: 2,
    ...
    location: "Pokhara",
    rating: 5,
    text: "Finally, skincare that actually feels natural. No more harsh chemicals. My sensitive skin loves Nepvic products.",
    product: "Face Wash"
  },
  {
    id: 3,
    ...
    location: "Lalitpur",
    rating: 5,
    text: "The Moisturizer is absolutely divine. It absorbs beautifully and keeps my skin hydrated all day long.",
    product: "Moisturizer"
  },
  {
    id: 4,
    ...
    location: "Bhaktapur",
    rating: 5,
    text: "I have tried countless serums but nothing compares to the glow I get from Nepvic. Absolutely transformative.",
    product: "Face Serum"
  },
  {
    id: 5,
    ...
    location: "Biratnagar",
    rating: 5,
    text: "The Sunscreen gives amazing protection without leaving any white cast. Perfect for our sunny weather.",
    product: "Sunscreen"
  },
  {
    id: 6,
    ...
    location: "Chitwan",
    rating: 5,
    text: "My acne-prone skin has cleared up since switching to Nepvic. Natural ingredients really make a difference.",
    product: "Face Wash"
  },
  {
    id: 7,
    ...
    location: "Butwal",
    rating: 5,
    text: "The texture of the Face Serum is perfection. It absorbs quickly and leaves my skin glowing.",
    product: "Face Serum"
  },
  {
    id: 8,
    ...
    location: "Hetauda",
    rating: 5,
    text: "I love that Nepvic is sulphate and paraben free. Great products that are gentle on my skin.",
    product: "Moisturizer"
  },
  {
    id: 9,
